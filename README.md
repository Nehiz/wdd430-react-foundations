...
|---|---|---:|
| 1 | About React and Next.js | :white_large_square: |
| 2 | Rendering UI | :white_large_square: |
...
- The Chapter 5 demo is a small, in-browser demo that uses UMD React + Babel standalone for learning purposes. It's located at `chapters/chapter-05/index.html`.
